...
access_array:
    ...
    mov ecx, [ g_c_array_length ]   # length of array
    mov eax, [ g_c_array + ( ecx - 1 ) * 4 ] 
...
access_string:
    ...
    mov [ g_c_hello + 0 ], byte ptr 'N'
    mov [ g_c_hello + 1 ], byte ptr 'i'
    mov [ g_c_hello + 2 ], byte ptr 'c'
    mov [ g_c_hello + 3 ], byte ptr 'e'
